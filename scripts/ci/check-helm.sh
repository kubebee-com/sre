...
require_text "$default_rendered" 'image: "ghcr.io/kubebee-com/sre-agent:sha-d94b738"'
require_text "$default_rendered" 'command: ["/usr/local/bin/sre-agent"]'
...
require_text "$digest_rendered" 'image: "ghcr.io/kubebee-com/sre-agent@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"'
